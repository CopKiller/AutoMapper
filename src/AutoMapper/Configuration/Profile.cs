...
public class Profile : IProfileExpressionInternal, IProfileConfiguration
{
    ...
    protected internal Profile(string profileName) : this()
    {
    ...
    protected Profile()
    {
        ...
        _memberConfiguration = new MemberConfiguration { NameToMemberMappers = { _prePostfixName } };
    }

    protected internal Profile(string profileName, Action<IProfileExpression> configurationAction) : this(profileName)
    {
    ...
    IReadOnlyCollection<Action<TypeMap, IMappingExpression>> IProfileConfiguration.AllTypeMapActions =>
        _allTypeMapActions.NullCheck();
    ...
    {
        _constructorMappingEnabled = false;
    }
    ...
    void IProfileExpressionInternal.ForAllPropertyMaps(Func<PropertyMap, bool> condition,
        Action<PropertyMap, IMemberConfigurationExpression> configuration)
    {
        _allPropertyMapActions ??= [];
        _allPropertyMapActions.Add(new PropertyMapAction(condition, configuration));
    }
    ...
    {
        return (IProjectionExpression<TSource, TDestination>)CreateMapCore<TSource, TDestination>(memberList,
            true);
    }

    public IMappingExpression<TSource, TDestination> CreateMap<TSource, TDestination>()
    {
        return CreateMapCore<TSource, TDestination>(MemberList.Destination);
    }

    public IMappingExpression<TSource, TDestination> CreateMap<TSource, TDestination>(MemberList memberList)
    {
        return CreateMapCore<TSource, TDestination>(memberList);
    }

    private IMappingExpression<TSource, TDestination> CreateMapCore<TSource, TDestination>(MemberList memberList,
    ...
    {
        _prefixes.TryAdd(prefixes);
    }

    public void RecognizePostfixes(params string[] postfixes)
    {
        _postfixes.TryAdd(postfixes);
    }
