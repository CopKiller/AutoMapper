...
public interface
    IMemberConfigurationExpression<TSource, TDestination, TMember> : IProjectionMemberConfiguration<TSource,
    TDestination,
    TMember>
{
    /// <summary>
...
public interface IMemberConfigurationExpression : IMemberConfigurationExpression<object, object, object>
{
    ...
    void MapFrom<TSource, TDestination, TSourceMember, TDestMember>(
        IMemberValueResolver<TSource, TDestination, TSourceMember, TDestMember> valueResolver, string sourceMemberName);
