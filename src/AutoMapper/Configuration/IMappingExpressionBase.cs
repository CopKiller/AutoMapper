    ...
    where TMappingExpression : IProjectionExpressionBase<TSource, TDestination, TMappingExpression>
{
    ...
    /// <returns>Itself</returns>
    TMappingExpression ForCtorParam(string ctorParamName,
...
/// <typeparam name="TMappingExpression">Concrete return type for fluent interface</typeparam>
public interface
    IMappingExpressionBase<TSource, TDestination, out TMappingExpression> : IProjectionExpressionBase<TSource,
    TDestination,
    TMappingExpression>
    where TMappingExpression : IMappingExpressionBase<TSource, TDestination, TMappingExpression>
{
    ...
    /// <returns>Itself</returns>
    TMappingExpression ForSourceMember(string sourceMemberName,
