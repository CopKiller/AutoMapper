...
public class MemberConfigurationExpression<TSource, TDestination, TMember>(
    ...
    Type sourceType) : IMemberConfigurationExpression<TSource, TDestination, TMember>, IPropertyMapConfiguration
{
    ...
    {
        MapFromCore(new ClassValueResolver(typeof(TValueResolver),
    ...
    private void MapFromCore<TValueResolver, TSourceMember>(Expression<Func<TSource, TSourceMember>> sourceMember,
        string sourceMemberName = null)
        where TValueResolver : IMemberValueResolver<TSource, TDestination, TSourceMember, TMember>
    {
        MapFromCore(new ClassValueResolver(typeof(TValueResolver),
            typeof(IMemberValueResolver<TSource, TDestination, TSourceMember, TMember>), sourceMemberName)
        {
    ...
    {
        MapFromCore(new ClassValueResolver(valueResolver, typeof(IValueResolver<TSource, TDestination, TMember>)));
    }
    ...
    {
        MapFromCore(new ClassValueResolver(valueResolver,
    ...
    public void AddTransform(Expression<Func<TMember, TMember>> transformer)
    {
        PropertyMapActions.Add(pm =>
            pm.AddValueTransformation(new ValueTransformerConfiguration(pm.DestinationType, transformer)));
    }

    public void ExplicitExpansion(bool value)
    {
        PropertyMapActions.Add(pm => pm.ExplicitExpansion = value);
    }
    ...
    {
        PropertyMapActions.Add(pm => pm.AllowNull = value);
    }

    public void UseDestinationValue()
    {
        SetUseDestinationValue(true);
    }
    ...
    {
        ConvertUsingCore(new ValueConverter(typeof(TValueConverter), typeof(IValueConverter<TSourceMember, TMember>),
            sourceMemberName)
        {
            SourceMemberLambda = sourceMember
        });
    ...
    {
        SetResolver(converter);
    }

    private void ConvertUsingCore<TSourceMember>(IValueConverter<TSourceMember, TMember> valueConverter,
        Expression<Func<TSource, TSourceMember>> sourceMember = null, string sourceMemberName = null)
    {
        ConvertUsingCore(new ValueConverter(valueConverter, typeof(IValueConverter<TSourceMember, TMember>),
            sourceMemberName)
        {
            SourceMemberLambda = sourceMember
        });
    ...
    public void Configure(TypeMap typeMap)
    {
        ...
        {
            destMember = Array.Find(typeMap.DestinationTypeDetails.ReadAccessors,
    ...
    public LambdaExpression GetDestinationExpression()
    {
        return DestinationMember.Lambda();
    }
    ...
    public IPropertyMapConfiguration Reverse()
    {
        ...
        if (_sourceMembers != null)
        {
            ...
            MemberConfigurationExpression<TDestination, TSource, object> reversedMemberConfiguration =
                new(_sourceMembers[0], destinationType);
        ...
        return PathConfigurationExpression<TDestination, TSource, object>.Create(SourceExpression,
            GetDestinationExpression());
    }

    public void DoNotUseDestinationValue()
    {
        SetUseDestinationValue(false);
    }
}

public sealed class MemberConfigurationExpression(MemberInfo destinationMember, Type sourceType)
    : MemberConfigurationExpression<object, object, object>(destinationMember, sourceType),
        IMemberConfigurationExpression
{
    public void MapFrom(Type valueResolverType)
    {
        MapFromCore(new ClassValueResolver(valueResolverType,
    ...
    public void MapFrom<TSource, TDestination, TSourceMember, TDestMember>(
        IMemberValueResolver<TSource, TDestination, TSourceMember, TDestMember> resolver, string sourceMemberName)
    {
        MapFromCore(new ClassValueResolver(resolver,
    ...
    {
        ConvertUsingCore(valueConverterType);
    }
    ...
    public void ConvertUsing<TSourceMember, TDestinationMember>(
        IValueConverter<TSourceMember, TDestinationMember> valueConverter, string sourceMemberName)
    {
        base.ConvertUsingCore(new ValueConverter(valueConverter,
    ...
    {
        base.ConvertUsingCore(new ValueConverter(valueConverterType,
            valueConverterType.GetGenericInterface(typeof(IValueConverter<,>)), sourceMemberName));
    }
}