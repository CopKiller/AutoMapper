...
internal interface IInternalRuntimeMapper : IRuntimeMapper
{
    TDestination Map<TSource, TDestination>(TSource source, TDestination destination, ResolutionContext context,
        Type sourceType = null, Type destinationType = null, MemberMap memberMap = null);
...
public sealed class Mapper : IMapper, IInternalRuntimeMapper
{
    ...
    public Mapper(IConfigurationProvider configuration, Factory serviceCtor)
    {
        ...
        _defaultContext = new ResolutionContext(this);
    }
    ...
    {
        return MapCore(source, destination, _defaultContext);
    }

    public TDestination Map<TSource, TDestination>(TSource source, TDestination destination,
        Action<IMappingOperationOptions<TSource, TDestination>> opts)
    {
        return MapWithOptions(source, destination, opts);
    }

    public object Map(object source, Type sourceType, Type destinationType)
    {
        return Map(source, null, sourceType, destinationType);
    }

    public object Map(object source, Type sourceType, Type destinationType, Action<IObjectMappingOperationOptions> opts)
    {
        return Map(source, null, sourceType, destinationType, opts);
    }

    public object Map(object source, object destination, Type sourceType, Type destinationType)
    {
        return MapCore(source, destination, _defaultContext, sourceType, destinationType);
    }
    ...
    public IQueryable<TDestination> ProjectTo<TDestination>(IQueryable source, object parameters,
        params Expression<Func<TDestination, object>>[] membersToExpand)
    {
        return source.ProjectTo(ConfigurationProvider, parameters, membersToExpand);
    }
    ...
    public IQueryable ProjectTo(IQueryable source, Type destinationType, IDictionary<string, object> parameters,
        params string[] membersToExpand)
    {
        return source.ProjectTo(destinationType, ConfigurationProvider, parameters, membersToExpand);
    }
    ...
    {
        return MapCore(source, destination, context, sourceType, destinationType, memberMap);
    }

    private TDestination MapWithOptions<TSource, TDestination>(TSource source, TDestination destination,
        Action<IMappingOperationOptions<TSource, TDestination>> opts,
        Type sourceType = null, Type destinationType = null)
    {
        ...
        destination = MapCore(source, destination, new ResolutionContext(this, typedOptions), sourceType,
            destinationType);
    ...
    private TDestination MapCore<TSource, TDestination>(
        TSource source, TDestination destination, ResolutionContext context, Type sourceType = null,
        Type destinationType = null, MemberMap memberMap = null)
    {
        TypePair requestedTypes = new(typeof(TSource), typeof(TDestination));
        TypePair runtimeTypes = new(source?.GetType() ?? sourceType ?? typeof(TSource),
