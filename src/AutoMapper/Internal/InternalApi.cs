...
public static class InternalApi
{
    ...
    {
        return (IGlobalConfiguration)configuration;
    }

    public static IGlobalConfigurationExpression Internal(this IMapperConfigurationExpression configuration)
    {
        return (IGlobalConfigurationExpression)configuration;
    }

    public static IProfileExpressionInternal Internal(this IProfileExpression profile)
    {
        return (IProfileExpressionInternal)profile;
    }
}
...
public interface IGlobalConfiguration : IConfigurationProvider
{
    ...
    Func<TSource, TDestination, ResolutionContext, TDestination> GetExecutionPlan<TSource, TDestination>(
...
public interface IProfileExpressionInternal : IProfileExpression
{
    ...
    void ForAllPropertyMaps(Func<PropertyMap, bool> condition,
