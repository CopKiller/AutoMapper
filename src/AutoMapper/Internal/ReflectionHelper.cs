...
public static class ReflectionHelper
{
    ...
    {
        return configuration.GetIncludedTypeMaps(typeMap.IncludedDerivedTypes);
    }
    ...
    public static object MapMember(this ResolutionContext context, MemberInfo member, object source,
    ...
    {
        return new ArgumentOutOfRangeException(nameof(propertyOrField),
    ...
    {
        return GetMemberPath(type, fullMemberName.Split('.'), typeMap);
    }
