...
public sealed class ConstructorMapper : IObjectMapper
{
    ...
    {
        return GetConstructor(context.SourceType, context.DestinationType) != null;
    }

    private static ConstructorInfo GetConstructor(Type sourceType, Type destinationType)
    {
        return destinationType.GetConstructor(TypeExtensions.InstanceFlags, null, [sourceType], null);
    }
