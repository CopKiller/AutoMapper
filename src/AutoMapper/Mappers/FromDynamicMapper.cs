...
public sealed class FromDynamicMapper : IObjectMapper
{
    ...
    private static object Map(object source, object destination, Type destinationType, ResolutionContext context,
    ...
    {
        return Call(MapMethodInfo, sourceExpression, destExpression.ToObject(), Constant(destExpression.Type),
