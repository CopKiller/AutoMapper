...
public class DuplicateTypeMapConfigurationException(DuplicateTypeMapConfigurationException.TypeMapConfigErrors[] errors)
    : Exception
{
    public TypeMapConfigErrors[] Errors { get; } = errors;
    public override string Message { get; } = GetErrors(errors);

    private static string GetErrors(TypeMapConfigErrors[] errors)
    {
...
public class AutoMapperConfigurationException : Exception
{
    ...
    public readonly record struct TypeMapConfigErrors(
        TypeMap TypeMap,
